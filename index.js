...
const { signup, verify, login, verifyToken, sendPasswordResetLink, resetPassword, verifyLogin, verifyUser, verifyPayment, getUserByEmail, updateEmail }                      = require('./controllers/account')
const { create, addPhone, verifyPhone, getProfessionalDetails, updateProfessional, deleteTimesheet, updateProfessionalSecurityDetails, updateTimesheetShift, addTimesheet, getTimesheets, getSingletimesheet, updateShiftStatus, addBankDetails, updatedBankDetails, verifyProfessional, updatePhone }   = require('./controllers/professional')
...
app.put('/server/:userId/phone', verifyToken, verifyUser, verifyProfessional, updatePhone)
...
app.put('/server/:userId/email', verifyToken, verifyUser, updateEmail)
